...
<nav class="menu">
  <ol>
    <li class="menu-item"><a href="http://localhost/Techaura/student_home.php"><img src="home_icon.png" style="height: 30px">Home</a></li>
    <li class="menu-item">
      <a href="http://localhost/Techaura/student_event.php"><img src="event_icon.png" style="height: 30px">Event</a>
      <ol class="sub-menu">
        <li class="menu-item"><a href="http://localhost/Techaura/student_concat.php"><img src="concat.png" style="height: 30px">Concat</a></li>
        <li class="menu-item"><a href="">Ignite</a></li>
      </ol>
    </li>
    <li class="menu-item"><a href="http://localhost/Techaura/s_gallery/gallery.php"><img src="gallery_icon.png" style="height: 30px">Gallery</a></li>
     <li class="menu-item"><a href="http://localhost/Techaura/student_contact.php"><img src="contact_icon.png" style="height: 30px">Contact</a></li>
    <li class="menu-item"><a href="http://localhost/Techaura/student_aboutus.php"><img src="aboutus_icon.png" style="height: 30px"> About us</a></li>
    <li class="menu-item">
      <a href="http://localhost/Techaura/home.php"><img src="login_icon.png" style="height: 30px">Logout</a>
    </li>
